 ...
 const [playSound] = useSound(audio)
  ...
  return (
    <div className="flex w-full justify-between items-center">
        <div className="">
            <h2 className={`mb-[9px] text-[32px] md:text-[64px]  font-bold text-black-20 dark:text-white`}>{word}</h2>
            <span className={`text-primary text-lg md:text-2xl font-normal `}>{phonetic}</span>
        </div>
